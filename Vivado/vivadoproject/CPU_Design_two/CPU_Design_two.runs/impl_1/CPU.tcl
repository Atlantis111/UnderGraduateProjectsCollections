...
namespace eval ::optrace {
  variable script "E:/vivadoproject/CPU_Design_two/CPU_Design_two.runs/impl_1/CPU.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/vivadoproject/CPU_Design_two/CPU_Design_two.runs/synth_1/CPU.dcp
